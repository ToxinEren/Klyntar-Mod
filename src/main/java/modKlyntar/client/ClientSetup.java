...
public class ClientSetup {
    ...
    public static void onRegisterAdditionalModels(ModelEvent.RegisterAdditional event) {
        event.register(new ModelResourceLocation(MyMod.MOD_ID, "capsule_gui", "inventory"));
        event.register(new ModelResourceLocation(MyMod.MOD_ID, "venomcapsule_gui", "inventory"));
    }
}