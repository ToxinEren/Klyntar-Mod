...
public final class VenomTentaclesTraversalClientController {
    ...
    private VenomTentaclesTraversalClientController() {
    }
    ...
    public static void onClientTick(TickEvent.ClientTickEvent event) {
        ...
        if (VenomTentaclesTraversalRenderer.getAnchors(player.getId()).size() < MIN_ARMS_FOR_TENTACLES_TRAVERSAL) {
            return;
        }
        ...
        ModNetwork.syncVenomTentaclesTraversalVelocity(next);
    }
