PalladiumEvents.registerAnimations((event) => {
    event.register('klyntar/spidermanmilesclimb', 5, (builder) => {
        if (abilityUtil.isEnabled(builder.getPlayer(), "klyntars:spidermanmiles", "climb_hanging")) {
        ...
        if (abilityUtil.isEnabled(builder.getPlayer(), "klyntars:spidermanmiles", "climb_ceiling")) {
            if (!builder.isFirstPerson()) {
                builder.get('head')
                    .setXRotDegrees(-55)
                    .setYRotDegrees(0)
...
PalladiumEvents.registerAnimations((event) => {
    event.register('klyntar/spidermanmilesclimb1', 10, (builder) => {
        ...
        let progress_climb1 = animationUtil.getAnimationTimerAbilityValue(builder.getPlayer(), 'klyntars:spidermanmiles', 'climb_1', builder.getPartialTicks());
...
PalladiumEvents.registerAnimations((event) => {
    event.register('klyntar/spidermanmilesclimb2', 10, (builder) => {
        ...
        let progress_climb2 = animationUtil.getAnimationTimerAbilityValue(builder.getPlayer(), 'klyntars:spidermanmiles', 'climb_2', builder.getPartialTicks());
