PalladiumEvents.registerAnimations((event) => {
 event.registerForPower('klyntar/lefttalon2','klyntars:venom', 10, (builder) => {
        // animation part
        const progress = animationUtil.getAnimationTimerAbilityValue(builder.getPlayer(), 'klyntars:venom', 'lefttalon2', builder.getPartialTicks());
