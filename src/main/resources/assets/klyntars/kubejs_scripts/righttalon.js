PalladiumEvents.registerAnimations((event) => {
 event.registerForPower('klyntar/righttalon','klyntars:venom', 10, (builder) => {
        // animation part
        const progress = animationUtil.getAnimationTimerAbilityValue(builder.getPlayer(), 'klyntars:venom', 'righttalon', builder.getPartialTicks());
