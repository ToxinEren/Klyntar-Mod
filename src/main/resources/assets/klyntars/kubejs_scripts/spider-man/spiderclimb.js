PalladiumEvents.registerAnimations((event) => {
    event.register('klyntar/spidermanclimb', 5, (builder) => {
        if (abilityUtil.isEnabled(builder.getPlayer(), "klyntars:spiderman", "climb_hanging")) {
        ...
        if (abilityUtil.isEnabled(builder.getPlayer(), "klyntars:spiderman", "climb_ceiling")) {
            if (!builder.isFirstPerson()) {
                builder.get('head')
                    .setXRotDegrees(-55)
                    .setYRotDegrees(0)
...
PalladiumEvents.registerAnimations((event) => {
    event.register('klyntar/spidermanclimb1', 10, (builder) => {
        ...
        let progress_climb1 = animationUtil.getAnimationTimerAbilityValue(builder.getPlayer(), 'klyntars:spiderman', 'climb_1', builder.getPartialTicks());
...
PalladiumEvents.registerAnimations((event) => {
    event.register('klyntar/spidermanclimb2', 10, (builder) => {
        ...
        let progress_climb2 = animationUtil.getAnimationTimerAbilityValue(builder.getPlayer(), 'klyntars:spiderman', 'climb_2', builder.getPartialTicks());
