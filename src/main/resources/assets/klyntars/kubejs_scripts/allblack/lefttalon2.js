PalladiumEvents.registerAnimations((event) => {
 event.registerForPower('klyntar/allblacklefttalon2','klyntars:allblack', 10, (builder) => {
        // animation part
        const progress = animationUtil.getAnimationTimerAbilityValue(builder.getPlayer(), 'klyntars:allblack', 'lefttalon2', builder.getPartialTicks());
