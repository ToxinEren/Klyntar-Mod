PalladiumEvents.registerAnimations((event) => {
 event.registerForPower('klyntar/allblackrighttalon','klyntars:allblack', 10, (builder) => {
        // animation part
        const progress = animationUtil.getAnimationTimerAbilityValue(builder.getPlayer(), 'klyntars:allblack', 'righttalon', builder.getPartialTicks());
