PalladiumEvents.registerAnimations((event) => {
 event.registerForPower('klyntar/lefttalon','klyntars:venom', 10, (builder) => {
        // animation part
        const progress = animationUtil.getAnimationTimerAbilityValue(builder.getPlayer(), 'klyntars:venom', 'lefttalon', builder.getPartialTicks());
