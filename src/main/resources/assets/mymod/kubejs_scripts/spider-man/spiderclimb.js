PalladiumEvents.registerAnimations((event) => {
    event.register('throgaddon/spidermanclimb', 5, (builder) => {
...
PalladiumEvents.registerAnimations((event) => {
    event.register('throgaddon/spidermanclimb1', 10, (builder) => {
...
PalladiumEvents.registerAnimations((event) => {
    event.register('throgaddon/spidermanclimb2', 10, (builder) => {
